    ...
    return (React.createElement(EmailLayout, { preview: `Booking confirmed - Payment received ${finalPrice}` },
        ...
        React.createElement(Section, { style: content },
            ...
            (subtotal || platformFee || captainEarnings) && (React.createElement(Section, { style: detailsSection },
                ...
                React.createElement(InfoBox, { label: "Total Payment Received", value: finalPrice }),
                subtotal && React.createElement(InfoBox, { label: "Trip Price", value: subtotal }),
                platformFee && (React.createElement(InfoBox, { label: "Platform Fee", value: `-${platformFee}` })),
