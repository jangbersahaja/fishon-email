...
export async function renderDepositConfirmedAnglerEmail(props) {
    return render(React.createElement(DepositConfirmedAnglerEmail, props));
}
export async function renderDepositReceivedCaptainEmail(props) {
    return render(React.createElement(DepositReceivedCaptainEmail, props));
}
export async function renderBalanceReminderAnglerEmail(props) {
    return render(React.createElement(BalanceReminderAnglerEmail, props));
}
export async function renderTripCompletedDepositEmail(props) {
